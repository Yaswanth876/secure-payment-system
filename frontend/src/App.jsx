...
function App() {
  ...
  return <div className="app-shell">
    ...
    <nav className="bottom-nav" aria-label="Primary navigation"><button className={view === 'home' ? 'active' : ''} onClick={() => setView('home')}><span>⌂</span>Home</button><button className={view === 'activity' ? 'active' : ''} onClick={() => setView('activity')}><span>≡</span>Activity</button><button className={view === 'pay' ? 'active' : ''} onClick={startPayment}><span>＋</span>Pay</button></nav>
  </div>;
}
